    ...
    return (
        <header className="fixed top-0 left-0 right-0 h-20 z-50 flex items-center justify-between px-6 md:px-10 bg-black/80 backdrop-blur-xl border-b border-white/10">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="relative pl-4 border-l border-white/10" ref={menuRef as RefObject<HTMLDivElement>}>
                    <button
                    ...
                    >
                        ...
                        <div
                            className={`h-10 w-10 rounded-full bg-gradient-to-r from-cyan-500 to-purple-600 p-[2px] transition-transform duration-300 ${
                                isMenuOpen ? "scale-110 shadow-[0_0_15px_rgba(6,182,212,0.5)]" : ""
                            }`}
                        >
                            <img
                                src={
                    ...
                    {isMenuOpen && (
                        <div className="absolute right-0 top-full mt-4 w-64 bg-black/90 backdrop-blur-xl border border-white/10 rounded-xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)] overflow-hidden animate-in fade-in slide-in-from-top-5 duration-200 z-50">
                                    ...
                                    >
                                        ...
                                        <ChevronRight
                                            ...
                                            className={`transition-transform duration-200 ${
                                                isBlogExpanded ? "rotate-90" : ""
                                            }`}
                                        />
                                    </button>

                                    {isBlogExpanded && (
                                        <div className="ml-4 pl-4 border-l border-white/10 space-y-1 my-1 animate-in slide-in-from-left-2 duration-200">
                                            <Link
                                                to="/blogManager/*"
