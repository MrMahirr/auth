        ...
        <div className="flex items-center">
            <label className="relative inline-flex items-center cursor-pointer select-none w-52 h-9">
                ...
                />
                    ...
                    <div className={`absolute inset-0 rounded-full border transition-colors duration-500 ease-in-out shadow-inner overflow-hidden
                            ${isFirestore
                        ...
                        <div className="absolute inset-0 flex items-center justify-between px-4 font-bold font-mono text-[10px] z-0">
                            <span className={`transition-opacity duration-300 ${!isFirestore ? 'opacity-0' : 'opacity-50 text-blue-300'}`}>
                            POSTGRES
                            </span>
                            <span className={`transition-opacity duration-300 ${isFirestore ? 'opacity-0' : 'opacity-50 text-orange-300'}`}>
                            FIRESTORE
                            </span>
                        </div>
                    </div>
                    ...
                    <div className={`absolute top-0.5 left-0.5 w-[100px] h-8 rounded-full flex items-center justify-center gap-1.5
                        ...
                        `}>
                            {isFirestore ? (
                                <>
                                    ...
                                    <span className="text-white font-bold tracking-wide text-[10px]">FIRESTORE</span>
                                </>
                            ) : (
                                <>
                                    <Database size={14} className="text-white"/>
                                    <span className="text-white font-bold tracking-wide text-[10px]">POSTGRES</span>
                                </>
                            )}
                    </div>
